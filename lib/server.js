...
app.get("/v1/explorers/mission/:mission", (req, res) => {
...
app.get("/v1/explorers/stack/:stack", (req, res) => {
    ...
    const explorerByStack = ExplorerController.getExplorersByStack(stack);
    res.json({stack: stack, explorers: explorerByStack});
});
